  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente nisi delectus id est eaque, nostrum at veritatis repellendus unde in ullam deserunt. Vitae laboriosam soluta quo repellendus praesentium consequatur mollitia.</p>
            {/* Stats */}
            <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
                ...
                <div>
                    <h3 className='text-3xl font-bold'>2200+</h3>
